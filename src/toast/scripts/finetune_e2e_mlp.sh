        ...
        do
            ...
            do
                ...
                do
                    ...
                    do
                        echo "=== E2E-MLP | dataset=$dataset_name | model=$model_name | skip=$to_approximate | mlp=$mlp_to_linearize | translator=$translator_name | seed=$seed ==="
                        python src/toast/utils/finetune_e2e_mlp.py \
                            ...
                            --batch_size=128 \
                            --weight_decay=1e-4 \
                            --results_file=finetune_e2e_mlp.csv \
                            --use_wandb=False
                        echo
                    done
                done
